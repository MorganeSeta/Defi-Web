...
if(squidematics_color == null){
	var squidematics_color = 'rgba(0, 0, 0, 0.3)';
}

if(squidematics_mainId == null){
	squidematics_mainId = mainId;
}

App.setup = function() {
  // Setup canvas and get canvas context
  var canvas = document.createElement('canvas');
  canvas.height = $('#'+squidematics_mainId).height();
  canvas.width = $('#'+squidematics_mainId).width();
  canvas.id = 'ourCanvas';
  document.getElementById(squidematics_mainId).appendChild(canvas);
