...
if (typeof rising_cubes_mainId === 'undefined' || rising_cubes_mainId === null) {
    rising_cubes_mainId = mainId;
}
var scene = new THREE.Scene();
scene.fog = new THREE.Fog(0x000000, 10, 15);
			var camera = new THREE.PerspectiveCamera( 45, $("#"+rising_cubes_mainId).width()/$("#"+rising_cubes_mainId).height(), 0.1, 1000 );

			var renderer = new THREE.WebGLRenderer();
			renderer.setSize( $("#"+rising_cubes_mainId).width(), $("#"+rising_cubes_mainId).height() );
			document.getElementById(rising_cubes_mainId).appendChild( renderer.domElement );
...
function onWindowResize(){
    ...
    camera.aspect = $("#"+rising_cubes_mainId).width() / $("#"+rising_cubes_mainId).height();
