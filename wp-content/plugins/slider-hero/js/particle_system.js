...
if(particle_system_mainId  == null){
	particle_system_mainId  = mainId;
}

var mainArea = document.getElementById(particle_system_mainId);
var createCanvas = mainArea.appendChild(document.createElement('canvas'));
createCanvas.setAttribute("id", "hero_particle_system");
...
function init()
{
  ...
  canvas = document.getElementById('hero_particle_system');
...
function resize()
{
  canvas.width = $('#'+particle_system_mainId).width();
  canvas.height = $('#'+particle_system_mainId).height();
