...
if(total_circle == null){
	var total_circle = '16';
}


if (typeof circle_mainId === 'undefined' || circle_mainId === null) {
    circle_mainId = mainId;
}

var mainArea = document.getElementById(circle_mainId);
...
var cw = canvas.width = $('#'+circle_mainId).width(),
  cx = cw / 2;
var ch = canvas.height = $('#'+circle_mainId).height(),
  cy = ch / 2;
...
function Init() {
  ...
  cw = canvas.width = $('#'+circle_mainId).width(),
    cx = cw / 2;
  ch = canvas.height = $('#'+circle_mainId).height(),
    cy = ch / 2;
