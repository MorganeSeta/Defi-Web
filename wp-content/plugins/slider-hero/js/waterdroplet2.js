...
if (typeof waterdropshine === 'undefined' || waterdropshine === null) {
    waterdropshine = '';
}



if (typeof waterdropalpha === 'undefined' || waterdropalpha === null) {
    waterdropalpha = '';
}


if (typeof waterdropbackground === 'undefined' || waterdropbackground === null) {
    waterdropbackground = '';
}


if (typeof waterdropforeground === 'undefined' || waterdropforeground === null) {
    waterdropforeground = '';
}


if (typeof waterdroplet_mainId === 'undefined' || waterdroplet_mainId === null) {
    waterdroplet_mainId = '';
}
...
const shaderData = {
  uniforms: {
    iResolution: {
      type: 'v2',
      value: [
        jQuery('#'+waterdroplet_mainId).width(),
        jQuery('#'+waterdroplet_mainId).height(),
      ],
    },
    vTextureSize: {
      type: 'v2',
...
class Application {
   ...
   */
  constructor() {
    this.width = jQuery('#'+waterdroplet_mainId).width();
    this.height = jQuery('#'+waterdroplet_mainId).height();

    // Define the assets that PIXI needs to preload to use later in the application
    this.loader = PIXI.loader
      .add(waterdropalpha)
      .add(waterdropshine)
      .add(waterdropbackground)
      .add(waterdropforeground)
  ...
  initialize() {
    ...
    //document.getElementById(waterdroplet_mainId).appendChild(this.stats.domElement);
...
class EffectCanvas {
  ...
  constructor(width, height, loader) {
    ...
    document.getElementById(waterdroplet_mainId).appendChild(this.renderer.view);
    ...
    shaderData.uniforms.uTextureDropShine.value = loader.resources[waterdropshine].texture;
    shaderData.uniforms.uTextureBackground.value = loader.resources[waterdropbackground].texture;
    shaderData.uniforms.uTextureForeground.value = loader.resources[waterdropforeground].texture;
    shaderData.uniforms.vTextureSize.value = [
      loader.resources[waterdropbackground].texture.width,
      loader.resources[waterdropbackground].texture.height,
    ];
...
class DropletManager {
  ...
  constructor(stage, loader) {
    ...
    this.dropletSmallTexture = loader.resources[waterdropalpha].texture;
    this.dropletLargeTexture = loader.resources[waterdropalpha].texture;
